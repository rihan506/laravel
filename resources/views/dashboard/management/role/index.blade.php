    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form role="form" action="{{ route('management.role.index') }}" method="POST" >
                    @csrf
                    <div class="row mb-2">
                        ...
                        <tbody>
                            @forelse ($bloggers as $blogger)
                                <tr>
                                    ...
                                    <td>
                                    <form id="herouser{{ $blogger->id }}" action="{{ route('management.role.assign',$blogger->id) }}" method="POST">
                                        @csrf
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                    <form id="herouser{{ $user->id }}" action="{{ route('management.role.blogger.down',$user->id) }}" method="POST">
                                        @csrf
                                        <div class="form-check form-switch">
