...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/lxjkkz768adffz3shj69a17kopx3u8h7jbqcdqlv41ky3z1n/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-title">Management And Role Permission</li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('profile.index') }}'>
                            <span class="menu-icon"><i class="fa-regular fa-face-smile-wink"></i></span>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuBlog">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='{{ route('bolg.index') }}'>
                                        <span class="menu-text">Show blogs</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='{{ route('bolg.create') }}'>
