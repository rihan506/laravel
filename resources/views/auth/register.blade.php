...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('dashboard') }}/{{ asset('dashboard') }}/assets/images/favicon.ico">
            ...
            <div class="col-xl-4 col-md-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" value="{{ old('name')}}" type="text" id="name" placeholder="Enter your namel" name="name">
                                @error('name')
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-white-50">Don't have an account? <a class='text-white font-weight-medium ms-1' href='{{ route('login') }}'>Sign Up</a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
